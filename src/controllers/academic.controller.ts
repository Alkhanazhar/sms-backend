...
export const getAllAcademicYears = async (
  ...
  try {
    ...
    await redisClient.setEx(`academicYears?page=${page}&limit=${limit}&search=${search}`, 60 * 5, JSON.stringify(responseData));
...
export const getCurrentAcademicYear = async (
  ...
  try {
    ...
    await redisClient.setEx(cacheKey, 60 * 5, JSON.stringify(currentYear));
